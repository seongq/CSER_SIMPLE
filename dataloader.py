...
class IEMOCAPDataset(Dataset):
    def __init__(self, train=True):
        ...
        self.testVid = pickle.load(open('/workspace/datasets/conversationalEMOTION/iemocap_multimodal_features.pkl', 'rb'), encoding='latin1')
...
class MELDDataset(Dataset):
    def __init__(self, train=True):
        ...
        self.roberta2, self.roberta3, self.roberta4, \
        self.videoAudio, self.videoVisual, self.videoSentence, self.trainVid,\
        self.testVid, _= pickle.load(open('/workspace/datasets/conversationalEMOTION/meld_multimodal_features.pkl', 'rb'), encoding='latin1')
